...
class LayerUpdater:
    ...
    def dbData(self):
        ...
        my_query = query_db("SELECT cubic_street, cubic_house_num, cubic_house_entrance_num, cubic_ip_address, cubic_switch_model, mon_ping_state, mon_traffic_state FROM "+city+"."+city+"_switches where mon_ping_state is not null or mon_traffic_state is not null")
        ...
        for i in my_query:
            ...
            newItem = QTreeWidgetItem([switches_list[5],switches_list[6],switches_list[4],switches_list[2],switches_list[0],switches_list[1],switches_list[3]])
